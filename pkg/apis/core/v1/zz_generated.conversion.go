...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.Resize)(nil), (*core.Resize)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_Resize_To_core_Resize(a.(*v1.Resize), b.(*core.Resize), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.Resize)(nil), (*v1.Resize)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_Resize_To_v1_Resize(a.(*core.Resize), b.(*v1.Resize), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.ResizeOptionsSpec)(nil), (*core.ResizeOptionsSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ResizeOptionsSpec_To_core_ResizeOptionsSpec(a.(*v1.ResizeOptionsSpec), b.(*core.ResizeOptionsSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ResizeOptionsSpec)(nil), (*v1.ResizeOptionsSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ResizeOptionsSpec_To_v1_ResizeOptionsSpec(a.(*core.ResizeOptionsSpec), b.(*v1.ResizeOptionsSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.ResizeOptionsStatus)(nil), (*core.ResizeOptionsStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ResizeOptionsStatus_To_core_ResizeOptionsStatus(a.(*v1.ResizeOptionsStatus), b.(*core.ResizeOptionsStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ResizeOptionsStatus)(nil), (*v1.ResizeOptionsStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ResizeOptionsStatus_To_v1_ResizeOptionsStatus(a.(*core.ResizeOptionsStatus), b.(*v1.ResizeOptionsStatus), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_Resize_To_core_Resize(in *v1.Resize, out *core.Resize, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1_ResizeOptionsSpec_To_core_ResizeOptionsSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1_ResizeOptionsStatus_To_core_ResizeOptionsStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_Resize_To_core_Resize is an autogenerated conversion function.
func Convert_v1_Resize_To_core_Resize(in *v1.Resize, out *core.Resize, s conversion.Scope) error {
	return autoConvert_v1_Resize_To_core_Resize(in, out, s)
}

func autoConvert_core_Resize_To_v1_Resize(in *core.Resize, out *v1.Resize, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_core_ResizeOptionsSpec_To_v1_ResizeOptionsSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_core_ResizeOptionsStatus_To_v1_ResizeOptionsStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_core_Resize_To_v1_Resize is an autogenerated conversion function.
func Convert_core_Resize_To_v1_Resize(in *core.Resize, out *v1.Resize, s conversion.Scope) error {
	return autoConvert_core_Resize_To_v1_Resize(in, out, s)
}

func autoConvert_v1_ResizeOptionsSpec_To_core_ResizeOptionsSpec(in *v1.ResizeOptionsSpec, out *core.ResizeOptionsSpec, s conversion.Scope) error {
	out.Resize = *(*map[string]core.ResourceRequirements)(unsafe.Pointer(&in.Resize))
	return nil
}

// Convert_v1_ResizeOptionsSpec_To_core_ResizeOptionsSpec is an autogenerated conversion function.
func Convert_v1_ResizeOptionsSpec_To_core_ResizeOptionsSpec(in *v1.ResizeOptionsSpec, out *core.ResizeOptionsSpec, s conversion.Scope) error {
	return autoConvert_v1_ResizeOptionsSpec_To_core_ResizeOptionsSpec(in, out, s)
}

func autoConvert_core_ResizeOptionsSpec_To_v1_ResizeOptionsSpec(in *core.ResizeOptionsSpec, out *v1.ResizeOptionsSpec, s conversion.Scope) error {
	out.Resize = *(*map[string]v1.ResourceRequirements)(unsafe.Pointer(&in.Resize))
	return nil
}

// Convert_core_ResizeOptionsSpec_To_v1_ResizeOptionsSpec is an autogenerated conversion function.
func Convert_core_ResizeOptionsSpec_To_v1_ResizeOptionsSpec(in *core.ResizeOptionsSpec, out *v1.ResizeOptionsSpec, s conversion.Scope) error {
	return autoConvert_core_ResizeOptionsSpec_To_v1_ResizeOptionsSpec(in, out, s)
}

func autoConvert_v1_ResizeOptionsStatus_To_core_ResizeOptionsStatus(in *v1.ResizeOptionsStatus, out *core.ResizeOptionsStatus, s conversion.Scope) error {
	out.Current = *(*map[string]core.ResourceRequirements)(unsafe.Pointer(&in.Current))
	return nil
}

// Convert_v1_ResizeOptionsStatus_To_core_ResizeOptionsStatus is an autogenerated conversion function.
func Convert_v1_ResizeOptionsStatus_To_core_ResizeOptionsStatus(in *v1.ResizeOptionsStatus, out *core.ResizeOptionsStatus, s conversion.Scope) error {
	return autoConvert_v1_ResizeOptionsStatus_To_core_ResizeOptionsStatus(in, out, s)
}

func autoConvert_core_ResizeOptionsStatus_To_v1_ResizeOptionsStatus(in *core.ResizeOptionsStatus, out *v1.ResizeOptionsStatus, s conversion.Scope) error {
	out.Current = *(*map[string]v1.ResourceRequirements)(unsafe.Pointer(&in.Current))
	return nil
}

// Convert_core_ResizeOptionsStatus_To_v1_ResizeOptionsStatus is an autogenerated conversion function.
func Convert_core_ResizeOptionsStatus_To_v1_ResizeOptionsStatus(in *core.ResizeOptionsStatus, out *v1.ResizeOptionsStatus, s conversion.Scope) error {
	return autoConvert_core_ResizeOptionsStatus_To_v1_ResizeOptionsStatus(in, out, s)
}
