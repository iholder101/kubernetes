...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.Resize)(nil), (*v1.Resize)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_Resize_To_v1_Resize(a.(*v1.Resize), b.(*v1.Resize), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.Resize)(nil), (*v1.Resize)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ResizeOptionsSpec)(nil), (*v1.ResizeOptionsSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ResizeOptionsSpec_To_v1_ResizeOptionsSpec(a.(*v1.ResizeOptionsSpec), b.(*v1.ResizeOptionsSpec), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.ResizeOptionsSpec)(nil), (*v1.ResizeOptionsSpec)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ResizeOptionsStatus)(nil), (*v1.ResizeOptionsStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ResizeOptionsStatus_To_v1_ResizeOptionsStatus(a.(*v1.ResizeOptionsStatus), b.(*v1.ResizeOptionsStatus), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.ResizeOptionsStatus)(nil), (*v1.ResizeOptionsStatus)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1_Resize_To_v1_Resize(in *v1.Resize, out *v1.Resize, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.Spec = in.Spec
...
// Convert_v1_Resize_To_v1_Resize is an autogenerated conversion function.
func Convert_v1_Resize_To_v1_Resize(in *v1.Resize, out *v1.Resize, s conversion.Scope) error {
	return autoConvert_v1_Resize_To_v1_Resize(in, out, s)
}
...
func autoConvert_v1_ResizeOptionsSpec_To_v1_ResizeOptionsSpec(in *v1.ResizeOptionsSpec, out *v1.ResizeOptionsSpec, s conversion.Scope) error {
	out.Resize = *(*map[string]v1.ResourceRequirements)(unsafe.Pointer(&in.Resize))
	return nil
}

// Convert_v1_ResizeOptionsSpec_To_v1_ResizeOptionsSpec is an autogenerated conversion function.
func Convert_v1_ResizeOptionsSpec_To_v1_ResizeOptionsSpec(in *v1.ResizeOptionsSpec, out *v1.ResizeOptionsSpec, s conversion.Scope) error {
	return autoConvert_v1_ResizeOptionsSpec_To_v1_ResizeOptionsSpec(in, out, s)
}
...
func autoConvert_v1_ResizeOptionsStatus_To_v1_ResizeOptionsStatus(in *v1.ResizeOptionsStatus, out *v1.ResizeOptionsStatus, s conversion.Scope) error {
	out.Current = *(*map[string]v1.ResourceRequirements)(unsafe.Pointer(&in.Current))
	return nil
}

// Convert_v1_ResizeOptionsStatus_To_v1_ResizeOptionsStatus is an autogenerated conversion function.
func Convert_v1_ResizeOptionsStatus_To_v1_ResizeOptionsStatus(in *v1.ResizeOptionsStatus, out *v1.ResizeOptionsStatus, s conversion.Scope) error {
	return autoConvert_v1_ResizeOptionsStatus_To_v1_ResizeOptionsStatus(in, out, s)
}
