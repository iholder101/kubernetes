			...
			Containers: []metricsv1beta1api.ContainerMetrics{
				{
					...
					Usage: v1.ResourceList{
						...
						v1.ResourceSwapMemory: *resource.NewQuantity(2*(1024*1024), resource.DecimalSI),
				...
				},
				{
					...
					Usage: v1.ResourceList{
						...
						v1.ResourceSwapMemory: *resource.NewQuantity(5*(1024*1024), resource.DecimalSI),
			...
			Containers: []metricsv1beta1api.ContainerMetrics{
				{
					...
					Usage: v1.ResourceList{
						...
						v1.ResourceSwapMemory: *resource.NewQuantity(8*(1024*1024), resource.DecimalSI),
				...
				},
				{
					...
					Usage: v1.ResourceList{
						...
						v1.ResourceSwapMemory: *resource.NewQuantity(11*(1024*1024), resource.DecimalSI),
				...
				},
				{
					...
					Usage: v1.ResourceList{
						...
						v1.ResourceSwapMemory: *resource.NewQuantity(14*(1024*1024), resource.DecimalSI),
